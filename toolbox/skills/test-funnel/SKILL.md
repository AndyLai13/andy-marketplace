...
- `test_case/Timer.md`（edu-vbos-finch，VB-82 / 385 / 386）— **乾淨範例**：純現狀、無彙總段、無歷史、廢棄項直接移除（符合〈維護紀律〉）。
- `test_case/freezer.md`（edu-vbos-finch，VB-579 / VB-882）— 格式與決策樹來源（per-row 三層分流）。**注意**：其檔尾仍留舊版「自動化盤點」彙總段，那是反例，新檔**別仿**。
